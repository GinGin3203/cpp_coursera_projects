...
void TestLoad() {
    ...
    for (int line = 0; line < 50000; ++line) { //50000 docs max
    ...
    for (int line = 0; line < 1000; ++line) { //500000 queries max
        ostringstream line_out;
    ...
    {
        LOG_DURATION("AddQueriesStreamTotal");
        srv.AddQueriesStream(queries_input, queries_output);
    }
}
